...
struct Z_CompiledInDeferFile_FID_Software_Epic_Games_Unreal_Projects_beibaoxitong_Plugins_BagSystem_Source_BagSystem_Public_Widgets_Bag_Spatial_Inv_BagGrid_h__Script_BagSystem_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_BagGrid, UInv_BagGrid::StaticClass, TEXT("UInv_BagGrid"), &Z_Registration_Info_UClass_UInv_BagGrid, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_BagGrid), 3227959550U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Software_Epic_Games_Unreal_Projects_beibaoxitong_Plugins_BagSystem_Source_BagSystem_Public_Widgets_Bag_Spatial_Inv_BagGrid_h__Script_BagSystem_339282239(TEXT("/Script/BagSystem"),
